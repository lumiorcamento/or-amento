...
export default function NuvemshopCallback() {
  ...
  useEffect(() => {
    async function handleCallback() {
      ...
      try {
        await nuvemshopService.connectCallback(currentStore.id, code, state);
        setStatus('success');
        ...
        setStatus('error');
        setError(err.message || 'Erro ao processar conexão com Nuvemshop.');
      ...
      <div className="max-w-md w-full bg-white rounded-2xl shadow-sm border border-gray-100 p-8 text-center">
        {status === 'processing' && (
          <div className="space-y-4">
            ...
            <h1 className="text-xl font-bold text-gray-900">Conectando sua Nuvemshop...</h1>
            <p className="text-sm text-gray-500">Estamos finalizando a integração com sua loja online.</p>
          </div>
        )}
        ...
        {status === 'success' && (
          <div className="space-y-4">
            ...
            <p className="text-sm text-gray-500">Sua loja Nuvemshop foi vinculada. Agora você pode ativar o botão de orçamento.</p>
            <div className="pt-4">
        ...
        {status === 'error' && (
          <div className="space-y-4">
            ...
            <h1 className="text-xl font-bold text-gray-900">Erro na Integração</h1>
